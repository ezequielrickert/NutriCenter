...
public interface IngredientRepository {
    ...
    void updateIngredient(Long ingredientID, String name, Allergy allergy, int proteins, int sodium, int calories, int totalFat, int cholesterol, int totalCarbohydrate);
